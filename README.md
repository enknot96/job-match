...
**🔗 デモ: [job-match-alpha.vercel.app](https://job-match-alpha.vercel.app/)**
...
私の勤め先では、求人に応募があると（多くの会社と同じく）**履歴書を AI に読ませて「自社に合いそうか」をざっくり見る**運用をしています。便利なのですが、ふと思いました。
...
開発サーバーを起動し、`/api/seed` を1度叩くと30人分のダミー応募者が投入されます。
